...
const PRODUCTS = [
  ...
  },
  {
    ...
    tag: "OA",
    badge: null,
    description: "Works on any online assessment conducted in a browser. One tool for every exam platform.",
        ...
        <div className="flex flex-col h-full">
          <div className={`relative aspect-[16/10] bg-gradient-to-br ${product.bgGradient} flex flex-col items-center justify-center p-8 overflow-hidden`}>
            ...
            <div className="absolute top-3 right-3">
              <ArrowUpRight size={14} className="text-[#9a8a8a]/40" />
            </div>
          </div>
  ...
  return (
    <section ref={sectionRef} className="relative mx-auto w-full px-6 sm:px-10 py-16 md:py-20 overflow-hidden">
      ...
      <div ref={headingRef} className="mb-12 md:mb-16 text-center">
        <span className="text-[12px] sm:text-xs font-bold uppercase tracking-wider text-accent block" style={{ opacity: 0 }}>Premium Bundle</span>
        <h2 className="mt-3 text-4xl font-bold tracking-tight text-ink md:text-5xl lg:text-6xl" style={{ opacity: 0 }}>
          Presenting Ozark <span className="text-accent">Alpha</span>
        </h2>
        <p className="mx-auto mt-4 max-w-[60ch] text-[16px] sm:text-[18px] leading-relaxed text-sub md:text-[19px]" style={{ opacity: 0 }}>
          One subscription to bypass top-level secured exams — HackerRank, Mercer Mettl, and Safe Exam Browser.
        </p>
